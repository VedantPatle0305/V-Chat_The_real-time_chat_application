      ...
      <div className='absolute  w-[100%]'>
        <div className='bg-[#1F71E6] pt-12 pb-3'>
          <button onClick={() => dispatch(setShowProfile(false))} className='flex items-center'>
            ...
            <h6 className='text-[20px] text-[#fff] font-semibold'>Profile</h6>
          </button>
        </div>
        <div className=' pt-5'>
          ...
          <p className='text-[14px] p-3 text-[#166e48] font-medium tracking-wide'>Your name</p> 
          ...
          <p className='text-[14px] p-3 text-[#166e48] font-medium tracking-wide'>Email</p> 
          <InputEdit type="email" handleChange={handleChange} input={formData.email} handleSubmit={submit} />
        </div>
