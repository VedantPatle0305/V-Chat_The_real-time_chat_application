...
function InputEdit({ type, handleChange, input, handleSubmit }) {
  ...
  return (
    <>
      <div className='flex flex-col py-3 bg-[#ffff] shadow-md px-4 gap-y-3'>
        {/* <p className='text-[12px] text-[#166e48] font-medium tracking-wide border border-red'>Your name</p> */}
        {
          !editable ?
